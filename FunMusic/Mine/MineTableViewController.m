...
static const CGFloat kHeaderViewHeight = 180;
static const CGFloat kUserImageViewSide = 100;
...
- (void)setUpHeaderUI
{
    ...
    //Login模块未建立，先使用固定信息
    [_userImageView setImage:[UIImage imageNamed:@"辰溪"]];
