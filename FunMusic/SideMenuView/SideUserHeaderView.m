...
static const CGFloat kYcenterFactor               = 0.6;
static const CGFloat kNameFont                    = 20;

@interface SideUserHeaderView ()
...
@implementation SideUserHeaderView
    ...
    [_userImageView mas_makeConstraints:^(MASConstraintMaker *make)
     {
         ...
         make.centerX.equalTo(self.mas_centerX).multipliedBy(kYcenterFactor);
     }];
